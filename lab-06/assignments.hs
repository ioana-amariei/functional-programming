...
ValuationPar care primeste trei argumente: 
o valuatie partiala, 
o variabila, 
o noua valoare :: Maybe Int pentru variabila respectiva 
si intoarce o noua valuatie partiala,
...
executaInstr valuatie (Atrib var val) = update valuatie var (evalp  val valuatie)
...
executaProgram valuatie (instruction:instructions) = executaProgram(executaInstr valuatie instruction) instructions
